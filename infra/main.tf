...
resource "google_storage_bucket" "website" {
    name = "example-website-by-allenttchen"
    location = "US"
}
...
# Upload the index.html file to Bucket
...
# Reserve a static external IP address for load balancer (not dynamic)
...
# Create GCP URL MAP: property in load balance
